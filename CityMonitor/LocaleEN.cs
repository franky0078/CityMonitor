    ...
    public class LocaleEN : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionTabLocaleID(Setting.kThresholdSection), "Color thresholds" },
                ...
                { m_Setting.GetOptionGroupLocaleID(Setting.kPopulationThresholdGroup), "Population and jobs" },
                { m_Setting.GetOptionGroupLocaleID(Setting.kCapacityThresholdGroup), "Capacity and traffic flow" },
                { m_Setting.GetOptionGroupLocaleID(Setting.kRiskThresholdGroup), "Risks" },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.UnemploymentGreenMax)),
                    "The status is green up to this unemployment rate." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.UnemploymentYellowMax)), "Unemployment: yellow up to" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.UnemploymentYellowMax)),
                    "The status is yellow up to this unemployment rate and red above it." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.HomelessGreenMax)), "Homelessness: green up to" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.HomelessGreenMax)),
                    "The status is green up to this homelessness rate." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.HomelessYellowMax)), "Homelessness: yellow up to" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.HomelessYellowMax)),
                    "The status is yellow up to this homelessness rate and red above it." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OpenJobsYellowMin)), "Open jobs: yellow from" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OpenJobsYellowMin)),
                    "The status changes from red to yellow at this share of open jobs." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OpenJobsGreenMin)), "Open jobs: green from" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OpenJobsGreenMin)),
                    "The status is green from this share of open jobs." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.SchoolYellowMin)), "School capacity: yellow from" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.SchoolYellowMin)),
                    "The status changes from red to yellow at this share of free school places." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.SchoolGreenMin)), "School capacity: green from" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.SchoolGreenMin)),
                    "The status is green from this share of free school places." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AvailabilityYellowMin)), "Availability: yellow from" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AvailabilityYellowMin)),
                    "Applies to healthcare, cemetery, crematorium, garbage, landfill, electricity, water, parking, post, and city attractiveness." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AvailabilityGreenMin)), "Availability: green from" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AvailabilityGreenMin)),
                    "The status is green from this availability value." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TrafficYellowMin)), "Traffic flow: yellow from" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.TrafficYellowMin)),
                    "The status changes from red to yellow at this traffic-flow value." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TrafficGreenMin)), "Traffic flow: green from" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.TrafficGreenMin)),
                    "The status is green from this traffic-flow value." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.FireHazardGreenMax)), "Fire hazard: green up to" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.FireHazardGreenMax)),
                    "The status is green up to this fire-hazard value." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.FireHazardYellowMax)), "Fire hazard: yellow up to" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.FireHazardYellowMax)),
                    "The status is yellow up to this fire-hazard value and red above it." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CrimeRiskGreenMax)), "Crime risk: green up to" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.CrimeRiskGreenMax)),
                    "The status is green up to this crime-risk value." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CrimeRiskYellowMax)), "Crime risk: yellow up to" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.CrimeRiskYellowMax)),
                    "The status is yellow up to this crime-risk value and red above it." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ResetColorThresholds)), "Reset color thresholds" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ResetColorThresholds)),
                    "Restores all color thresholds to their recommended default values." },

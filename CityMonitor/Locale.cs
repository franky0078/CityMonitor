    ...
    public class LocaleDE : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionTabLocaleID(Setting.kThresholdSection), "Farbgrenzwerte" },
                ...
                { m_Setting.GetOptionGroupLocaleID(Setting.kPopulationThresholdGroup), "Bevölkerung und Arbeit" },
                { m_Setting.GetOptionGroupLocaleID(Setting.kCapacityThresholdGroup), "Kapazitäten und Verkehrsfluss" },
                { m_Setting.GetOptionGroupLocaleID(Setting.kRiskThresholdGroup), "Risiken" },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.UnemploymentGreenMax)),
                    "Bis zu dieser Arbeitslosenquote wird der Status grün dargestellt." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.UnemploymentYellowMax)), "Arbeitslosigkeit: Gelb bis" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.UnemploymentYellowMax)),
                    "Bis zu dieser Arbeitslosenquote wird der Status gelb dargestellt; darüber rot." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.HomelessGreenMax)), "Obdachlosigkeit: Grün bis" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.HomelessGreenMax)),
                    "Bis zu dieser Obdachlosenquote wird der Status grün dargestellt." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.HomelessYellowMax)), "Obdachlosigkeit: Gelb bis" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.HomelessYellowMax)),
                    "Bis zu dieser Obdachlosenquote wird der Status gelb dargestellt; darüber rot." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OpenJobsYellowMin)), "Offene Stellen: Gelb ab" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OpenJobsYellowMin)),
                    "Ab diesem Anteil offener Stellen wird der Status gelb statt rot dargestellt." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OpenJobsGreenMin)), "Offene Stellen: Grün ab" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.OpenJobsGreenMin)),
                    "Ab diesem Anteil offener Stellen wird der Status grün dargestellt." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.SchoolYellowMin)), "Schulplätze: Gelb ab" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.SchoolYellowMin)),
                    "Ab diesem Anteil freier Schulplätze wird der Status gelb statt rot dargestellt." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.SchoolGreenMin)), "Schulplätze: Grün ab" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.SchoolGreenMin)),
                    "Ab diesem Anteil freier Schulplätze wird der Status grün dargestellt." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AvailabilityYellowMin)), "Verfügbarkeit: Gelb ab" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AvailabilityYellowMin)),
                    "Gilt für Krankenhaus, Friedhof, Krematorium, Müll, Deponie, Strom, Wasser, Parkplätze, Post und Stadtattraktivität." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AvailabilityGreenMin)), "Verfügbarkeit: Grün ab" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AvailabilityGreenMin)),
                    "Ab dieser Verfügbarkeit wird der Status grün dargestellt." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TrafficYellowMin)), "Verkehrsfluss: Gelb ab" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.TrafficYellowMin)),
                    "Ab diesem Verkehrsfluss wird der Status gelb statt rot dargestellt." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TrafficGreenMin)), "Verkehrsfluss: Grün ab" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.TrafficGreenMin)),
                    "Ab diesem Verkehrsfluss wird der Status grün dargestellt." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.FireHazardGreenMax)), "Brandgefahr: Grün bis" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.FireHazardGreenMax)),
                    "Bis zu dieser Brandgefahr wird der Status grün dargestellt." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.FireHazardYellowMax)), "Brandgefahr: Gelb bis" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.FireHazardYellowMax)),
                    "Bis zu dieser Brandgefahr wird der Status gelb dargestellt; darüber rot." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CrimeRiskGreenMax)), "Kriminalitätsrisiko: Grün bis" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.CrimeRiskGreenMax)),
                    "Bis zu diesem Kriminalitätsrisiko wird der Status grün dargestellt." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CrimeRiskYellowMax)), "Kriminalitätsrisiko: Gelb bis" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.CrimeRiskYellowMax)),
                    "Bis zu diesem Kriminalitätsrisiko wird der Status gelb dargestellt; darüber rot." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ResetColorThresholds)), "Farbgrenzwerte zurücksetzen" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ResetColorThresholds)),
                    "Stellt alle Farbgrenzwerte auf die empfohlenen Standardwerte zurück." },
